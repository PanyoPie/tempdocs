...
- $a_n = \dfrac{1}{\pi} \displaystyle \int_{-\pi}^\pi f(x) \cos(nx) \, \mathrm{d}x \;\;\; (n = 1, 2, 3, \dots)$
- $b_n = \dfrac{1}{\pi} \displaystyle \int_{-\pi}^\pi f(x) \sin(nx) \, \mathrm{d}x$
...
- $a_0 =\displaystyle \int_{-\pi}^\pi f(x) \, \mathrm{d}x$
- $a_n =\displaystyle \int_{-\pi}^\pi f(x) \cos(nx) \, \mathrm{d}x \;\;\; (n = 1, 2, 3, \dots)$
- $b_n =\displaystyle \int_{-\pi}^\pi f(x) \sin(nx) \, \mathrm{d}x$
...
<table style={{textAlign: 'center', display: 'table', width: '100%', maxWidth: '100%'}}>
  ...
  <tr>
    <td>$a_0 = \dfrac{2}{\pi} \displaystyle \int_0^\pi f(x) \, \mathrm{d}x$</td>
    <td rowspan="2">$b_n = \dfrac{2}{\pi} \displaystyle \int_0^\pi f(x) \sin(nx) \, \mathrm{d}x$</td>
  </tr>
  <tr>
    <td>$a_n = \dfrac{2}{\pi} \displaystyle \int_0^\pi f(x) \cos(nx) \, \mathrm{d}x$</td>
  </tr>
  <tr>
